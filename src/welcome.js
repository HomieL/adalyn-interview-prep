  ...
  document.getElementById('mainContent').innerHTML = `
    <div class="welcome">
      <div class="welcome-hero">
        <h1><em>${t(TARGET.shortZh, TARGET.short)}</em><br>${t('面试备考助手', 'Interview Prep')}</h1>
        <p>${t('输入技术文档 URL，AI 自动抓取内容并深度解析知识要点，<br>生成结构化学习框架，并出针对实习面试水平的定制题目。',
          'Enter a technical doc URL — AI fetches and deep-analyzes the content,<br>generating a structured knowledge framework and intern-level quiz questions.')}</p>
      </div>
      <div class="form-card">
        <div class="form-group">
